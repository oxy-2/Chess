Public Class Form1
            ...
            For col As Integer = 0 To 7
                If board(row, col) <> "" Then
                    Dim pieceLabel As New Label With {
                        .Text = board(row, col),
                        .ForeColor = If(row < 2, Color.DarkGray, Color.Black), ' Black/White text
                        .BackColor = System.Drawing.Color.FromArgb(70, 255, 255, 255),
    ...
    Private Sub Piece_Clicked(sender As Object, e As EventArgs)
        ...
        ' Toggle selection
        clickedPiece.BackColor = If(clickedPiece.BackColor = System.Drawing.Color.FromArgb(70, 255, 255, 255), System.Drawing.Color.FromArgb(100, 0, 200, 255), System.Drawing.Color.FromArgb(70, 255, 255, 255))
    End Sub
